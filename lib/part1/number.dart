...
class time extends StatelessWidget {
  ...
  time({Key key, this.nom, this.prenom, this.numero, this.immatriculation})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    Get.put(TimerController());
    return Number(nom: nom, prenom: prenom, numero: numero, immatriculation: immatriculation,);
  }
}

class Number extends GetView<TimerController> {
  final String nom;
  final String prenom;
  final String numero;
  final String immatriculation;
  Number({key, this.nom, this.prenom, this.numero, this.immatriculation}) : super(key: key);
                ...
                Container(
                  ...
                  child: TextButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                      MaterialPageRoute(builder: (context) => espaceClient2(nom: 'Brou', prenom: 'Yao Marc', numero: '+225 0797674576', immatriculation: '1234AB56',)),
                      );
                    },
                    child: Text(
                      "Soumettre",
